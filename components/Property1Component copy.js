...
const Property1Component = ({
  ...
  const property1Component1Style = useMemo(() => {
    return {
  ...
  return (
    <View style={[styles.property1component1, property1Component1Style]}>
      <View style={[styles.property1component1Child, rectangleViewStyle]} />
      <Text style={styles.maintenanceTaskSelection}>
